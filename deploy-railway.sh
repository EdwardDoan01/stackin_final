...
echo "   3. Run migrations: railway run python Stackin/manage.py migrate --settings=Stackin.settings_production"
echo "   4. Create superuser: railway run python Stackin/manage.py createsuperuser --settings=Stackin.settings_production"
